...
Para el Modelo de Predicción de Puntaje (Regression), donde el objetivo es que el modelo prediga el Total.Cup.Points basándose en variables como altitud, región, especie y procesamiento se destacan las siguiente gráficas:
